...
SOURCEFILES_QUOTED_IF_SPACED=hw2_main.s

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/hw2_main.o
POSSIBLE_DEPFILES=${OBJECTDIR}/hw2_main.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/hw2_main.o

# Source Files
SOURCEFILES=hw2_main.s
...
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/HW2.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
# Rules for buildStep: pic-as-assembler
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/hw2_main.o: hw2_main.s  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/hw2_main.o 
	${MP_AS} -mcpu=PIC18F57Q43 -c \
	-o ${OBJECTDIR}/hw2_main.o \
	hw2_main.s \
...
${DISTDIR}/HW2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	-o ${DISTDIR}/HW2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
